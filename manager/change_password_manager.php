					   ...
					   <br>
                          ...
                          <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><i class="icon-user"></i>&nbsp;Manager change Password</div>
								<div class="muted pull-right"><a id="return" data-placement="left" title="Click to Return" href="dashboard_manager.php"><i class="icon-arrow-left icon-large"></i> Back</a></div>
                            ...
                            <div class="block-content collapse in">
								...
								<?php
								$query = mysql_query("select * from manager where manager_id = '$session_id'")or die(mysql_error());
   ...
   <script>
			...
			jQuery("#change_password").submit(function(e){
					...
					$.ajax({
						...
						var delay = 2000;
							setTimeout(function(){ window.location = 'dashboard_manager.php'  }, delay);  
