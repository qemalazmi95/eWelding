            ...
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
						...
						<?php $query= mysql_query("select * from manager where manager_id = '$session_id'")or die(mysql_error());
						...
						?>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a tabindex="-1" href="change_password_manager.php"><i class="icon-cog"></i>&nbsp;Change Password</a>
