<div class="row-fluid">				  
   <a href="client_user.php" class="btn btn-info" id="add" data-placement="right" title="Click to Add New" ><i class="icon-plus-sign icon-large"></i> Add New Store Manager</a>
	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-pencil icon-large"></i> Edit Store Manager Info.</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = mysql_query("select * from store_manager where store_manager_id = '$get_id'")or die(mysql_error());
...
mysql_query("update store_manager set username = '$username'  , firstname = '$firstname' , lastname = '$lastname' where store_manager_id = '$get_id' ")or die(mysql_error());
...
<script>
 ...
 $.jGrowl("Store Manager Successfully Update", { header: 'Store manager Update' });  
</script>
<?php
}
?>