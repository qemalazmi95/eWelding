  ...
  <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <span class="brand" href="#">Welcome To: AZW e-Inventory System</span>
                    <div class="nav-collapse collapse">
                        <ul class="nav pull-right">
						<?php $query= mysql_query("select * from officer_clerk where officer_clerk_id = '$session_id'")or die(mysql_error());
						...
						?>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                       <a tabindex="-1" href="change_password_clerk.php"><i class="icon-cog"></i>&nbsp;Change Password</a>
