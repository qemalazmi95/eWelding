...
<?php
		...
		<td>
			...
			<td class="empty" width="80"><a rel="tooltip"  title="Edit Stock" id="e<?php echo $row['stock_id']; ?>" href="device_edit_stock.php<?php echo '?id='.$row['stock_id']; ?>" class="btn btn-info"><i class="icon-list-ul"> Edit</i> </a></td>
