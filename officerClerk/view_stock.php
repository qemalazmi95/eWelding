                     ...
                     <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
										...
										<div class="muted pull-right"><a id="return" data-placement="top" class="btn btn-info" title="Click to Return" href="stock.php"><i class="icon-arrow-left"></i> Back</a></p>		</div>
			<script type="text/javascript">
			$(document).ready(function(){
			$('#return').tooltip('show');
			$('#return').tooltip('hide');
