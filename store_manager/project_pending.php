...
<?php
		$device_query = mysql_query("select a.*, b.* from project a,
		 ...
		 and status_project= ('pending')")or die(mysql_error());
		...
		<td>
			...
			<td class="empty" width="80"><a rel="tooltip"  title="View Project Detial" id="e<?php echo $row['project_id']; ?>" href="view_project.php<?php echo '?id='.$row['project_id']; ?>" class="btn btn-info"><i class="icon-pencil"> view</i> </a></td>
            
            <td class="empty" width="80"><a rel="tooltip"  title="Withdrawal Stock" id="<?php echo $row['client_id']; ?>" href="stock_out.php?project_id=<?php echo $row['project_id']; ?>" class="btn btn-info"><i class="icon-pencil">withdraw</i> </a></t
